...
@SourceType(value = "PayPalARP", label = "PayPal",uiConfig = "paypal-layout.json")
public class PayPalConf extends AbstractArpConf<PayPalConf> {
  private static final String ARP_FILENAME = "arp/implementation/paypal-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.paypal.PayPalDriver";
